    ...
    tools: {
        thinking: {
            ...
            system: [
                ...
                'Факты — только блоки items в ленте (explore / work / web / logs / check). Системный промпт, brief и догадки — не факты; переформулировка задачи ради пропуска сбора запрещена.',
                'Первый ход по новой цели зависит от внешнего состояния (дерево, журнал, интернет, файлы) — сборщик, не answer/report/planning. Генерация с разумными дефолтами — прямое действие без сбора. Закрыватель без evidence в items недействителен.',
            ].join('\n'),
            prompt: [
