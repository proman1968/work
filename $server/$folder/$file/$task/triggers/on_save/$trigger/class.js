...
**plan** — планирование. Уточняй задачу формой, собирай факты (research), предлагай план. Не меняй файлы, не вызывай сервисы и навыки. Чтобы начать исполнение — активация: пользователь нажимает «Перейти к действиям».

**do** — исполнение. Делай конкретные шаги по плану и запросу: файлы, сервисы, навыки, формы, результат. Факты по ходу работы — снова research, без смены режима. Не планируй заново и не проси активацию. Выход из do — площадка check (доказательства: work/web, вердикт ok или fail), затем complete (итог, подтверждение пользователя). При fail проверку не закрывать.
`,
