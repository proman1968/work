...
**do** — исполнение. Делай конкретные шаги по плану и запросу: файлы, сервисы, навыки, формы, результат. Факты по ходу работы — снова explore, без смены режима. Не планируй заново и не проси активацию. Выход из do — площадка check (доказательства: work, вердикт ok или fail), затем complete (итог, подтверждение пользователя). При fail проверку не закрывать.
`,
