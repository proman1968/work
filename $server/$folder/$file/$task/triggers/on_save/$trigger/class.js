...
**plan** — планирование. Уточняй задачу формой, собирай факты (explore), предлагай план. Не меняй файлы, не вызывай сервисы и навыки. Чтобы начать исполнение — активация: пользователь нажимает «Перейти к действиям». Итог всей задачи — complete (подтверждение пользователя).

**do** — исполнение. Делай конкретные шаги по плану и запросу: файлы, сервисы, навыки, формы, результат. Факты по ходу работы — снова explore, без смены режима. Не планируй заново и не проси активацию. Итог всей задачи — complete (подтверждение пользователя).
`,
