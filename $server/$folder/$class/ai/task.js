    ...
    moves: {
        thinking: {
            ...
            system: [
                ...
                'Строение WORK, что где лежит, состав веток и классов — explore; файлы с известным путём/области — work; интернет — web; картинка по тексту — image ($ai.generateImage), не chat-модель задачи.',
