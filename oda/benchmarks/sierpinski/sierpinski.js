ODA({is: 'oda-root',
    ...
    ,
    get time(){
        return (this.elapsed / 1000) % 10
    },
    get scaleX(){
        return 1 + (this.time > 5 ? 10 - this.time : this.time) / 15
    },
    elapsed: 0,
...
ODA({is: 'oda-dot',
    ...
    hover: false,
    get hoverableText(){
        return this.hover ? `*${this.$pdp.seconds.toString()}*` : this.$pdp.seconds.toString();
    },
